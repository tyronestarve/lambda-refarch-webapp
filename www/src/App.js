            ...
            <Col md="6">
              {idToken.length > 0 ?
                (
                  ...
                  <Button
                    href={`https://${config.cognito_hosted_domain}/login?response_type=token&scope=email+openid&client_id=${config.aws_user_pools_web_client_id}&redirect_uri=${config.redirect_url}`}
                    color="primary"
